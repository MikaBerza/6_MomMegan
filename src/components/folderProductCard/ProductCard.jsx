    ...
    <div className={style['card']}>
      ...
      <div className={style['card__title']}>
        ...
        <svg
          className={
            rating > 4
              ? `${style['card__title-stars']} ${style['bg-stars-v1']}`
              : `${style['card__title-stars']} ${style['bg-stars-v2']}`
          }
          width='30px'
          height='30px'
          viewBox='0 0 576 512'
        ...
        <span
          className={
            rating > 4
              ? `${style['card__title-rating']} ${style['bg-rating-v1']}`
              : `${style['card__title-rating']} ${style['bg-rating-v2']}`
          }
        >
          {rating}
        </span>
