      ...
      <div className={style.header}>
        ...
        <Link to='/'>
          <div className={style['header__logo']}>
            <img
              className={style['header__logo-megan']}
              src={mLogo}
              alt='logo'
            />
            <div>
              <h1 className={style['header__title']}>Megan</h1>
        ...
        <div className='header__basket'>
          ...
          <Link to='/cart' className={style['header__button']}>
            ...
            <svg
              className={style['header__img-cart']}
              width='18px'
              height='18px'
              viewBox='0 0 24 24'
            ...
            <span className={style['header__counter']}>3</span>
          </Link>
        </div>
      </div>
    </div>
